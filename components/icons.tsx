...
export const DesignIcon: React.FC<IconProps> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
    </svg>
);

export const CodeIcon: React.FC<IconProps> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const QuoteIcon: React.FC<IconProps> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 16 16">
        <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388q0-.527.062-1.054.093-.558.31-.992t.559-.68.865-.366q.396 0 .744.059t.652.19.468.293.286.372l1.11-1.007A5.04 5.04 0 0 0 13.298 3.5a5.02 5.02 0 0 0-1.837-1.07A5.02 5.02 0 0 0 9.5 2.023q-1.42 0-2.43.973-1.01 1.02-1.01 2.585v3.106A1 1 0 0 0 7 10h1a1 1 0 0 0 1 1v1a1 1 0 0 0 1 1zM6 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612q0-.527.062-1.054.094-.558.31-.992t.559-.68.865-.366q.396 0 .744.059t.652.19.468.293.286.372l1.11-1.007A5.04 5.04 0 0 0 7.298 3.5a5.02 5.02 0 0 0-1.837-1.07A5.02 5.02 0 0 0 3.5 2.023q-1.42 0-2.43.973-1.01 1.02-1.01 2.585v3.106A1 1 0 0 0 1 10h1a1 1 0 0 0 1 1v1a1 1 0 0 0 1 1z" />
    </svg>
);
...
export const RocketIcon: React.FC<IconProps> = ({ className = "h-8 w-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
